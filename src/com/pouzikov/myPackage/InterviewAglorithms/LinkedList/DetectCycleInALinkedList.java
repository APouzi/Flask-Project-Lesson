package com.pouzikov.myPackage.InterviewAglorithms.LinkedList;
...
//linked list where the tail connects to. If pos == -1, then there is no cycle in the linked list.
//
//Follow up:
