...
public class MaximumSubarray {
    public static void main(String[] args) {
        ...
        System.out.println(maxSubArrayPractice(array));
    }

    public static int maxSubArrayPractice(int[] array){
        return 3;
    }
    ...
    public static int maxSubArrayPrac(int[] array){
        int maxAnswer = array[0];
        int currentSum = maxAnswer;
