...
public class ShuffleString {
    public static void main(String[] args) {
        ...
        System.out.println(shuffString(word,array));
    }

    public static String shuffString(String word, int[] array){
        return "problem";
    ...
    public static void shuffleString(String word, int[] array) {
            char[] newWord = new char[word.length()];
        for (int i = 0; i < word.length(); i++) {
            newWord[array[i]] = word.charAt(i);
        }
        newWord.toString();
