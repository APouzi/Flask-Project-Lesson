package com.pouzikov.myPackage.InterviewAglorithms.BreadthFirstSearch;
...
public class WordLadder {
    ...
    public static int ladderLengthP(String beginWord, String target, List<String> wordList){
...
//Now we are going to set up our queue,
        Queue<String> queue = new LinkedList();
        queue.offer(beginWord);
